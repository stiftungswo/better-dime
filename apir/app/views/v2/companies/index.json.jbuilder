...
json.set! :data do
  json.array! @companies do |company|
    json.extract! company.decorate, :id, :type, :comment, :company_id, :department, :department_in_address, :email, :first_name, :last_name, :hidden, :name, :accountant_id, :rate_group_id, :salutation, :created_at, :updated_at, :deleted_at, :created_by, :updated_by, :deleted_by
    ...
    json.set! :people do
      json.array! company.people do |person|
        json.extract! person, :id, :type, :comment, :company_id, :department, :department_in_address, :email, :first_name, :last_name, :hidden, :name, :accountant_id, :rate_group_id, :salutation, :created_at, :updated_at, :deleted_at, :created_by, :updated_by, :deleted_by
      end
    end
    json.set! :persons do
      json.array! company.people do |person|
