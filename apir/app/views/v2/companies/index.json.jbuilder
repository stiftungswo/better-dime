...
json.set! :data do
  json.array! @companies do |company|
    json.extract! company.decorate, :id, :type, :comment, :company_id, :department, :department_in_address, :email, :first_name, :last_name, :hidden, :name, :accountant_id, :rate_group_id, :salutation, :newsletter, :biodiversity_course, :created_at, :updated_at, :deleted_at, :created_by, :updated_by, :deleted_by
