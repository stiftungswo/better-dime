...
RSpec.describe "V2::Projects", type: :request do
  ...
  describe "GET /v2/projects/:id" do
    ...
    it "returns a project with costgroup distributions calculated including uncategorized" do
      ...
      create(:project_costgroup_distribution, project: project)
      ProjectEffort.insert({ date: "2019-05-14", value: 60, position_id: position.id, employee_id: employee.id, costgroup_number: nil }) # rubocop:disable Rails/SkipsModelValidations
