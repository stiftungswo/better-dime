...
ActiveRecord::Schema.define(version: 2022_07_22_122027) do
  ...
  create_table "customers", id: :integer, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "deleted_by"
    t.boolean "archived", default: false, null: false
    t.index ["accountant_id"], name: "accountant_id"
  ...
  create_table "services", id: :integer, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "local_order", default: 99, null: false
  ...
  add_foreign_key "customers", "employees", column: "accountant_id", name: "customers_ibfk_1"
  ...
  add_foreign_key "project_category_distributions", "project_categories", column: "category_id"
  add_foreign_key "project_category_distributions", "projects"
