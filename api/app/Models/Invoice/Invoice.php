...
class Invoice extends Model
{
    ...
    protected $fillable = ['accountant_id', 'address_id', 'customer_id', 'description', 'ending', 'fixed_price', 'fixed_price_vat', 'name', 'order', 'price_per_rate', 'project_id', 'rate_unit_id', 'beginning'];
